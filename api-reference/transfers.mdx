---
title: "Transfers API Module — GBM Plus Python SDK Reference"
sidebarTitle: "Transfers"
description: "Reference for gbm.transfers.transfer() — move MXN amounts between GBM+ investment strategies programmatically using the Python SDK."
---
