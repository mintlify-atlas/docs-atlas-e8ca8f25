---
title: "Buy US Stocks Using the GBM+ Trading USA API Platform"
sidebarTitle: "Trading USA"
description: "End-to-end example for looking up a US stock instrument ID and placing a fractional dollar-amount buy order using the GBM+ Trading USA platform."
---
